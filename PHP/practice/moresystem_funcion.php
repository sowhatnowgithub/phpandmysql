...
$possibility = substr($aloha, rand(0,25),1).substr($aloha,rand(0,25),1).substr($aloha,rand(0,25),1).substr($aloha,rand(0,25),1);
...
print "<p>The above will give the output - max is ".max(array(23,2,1,-234,0.3))." and min is ".min(array(23,2,1,-234,0.3)) ."</p>";
print "<h3>date function</h3>";
print "<p>date(\"d\") - this will give the date like 25 </p> - ".date("d");
print "<p>date(\"F\") - this will give the name of the month </p> - ".date("F");
...
print "<p>date(\"l F jS\") - jS will give the date with the suffix </p> - ".date("l F jS");
print "<p>date(\"g:i a .... D M j Y\") - time and date ".date("g:i a .... D M j Y");
print "<p>date(\"ymd\") - this is a common way to store date - ".date("ymd");
print "<p>date(\"L\") - this will teel us whether the year is leap year or not - one means leap year ".date("L");
switch (date("L")){
    case 1:
        print "<p>Leap Year </p>";
        break;
...
$chars = array("d","D","l(lower case L)","L","jS","S","y","Y","m","M","F","g","i","s","a");
$desc = array(
